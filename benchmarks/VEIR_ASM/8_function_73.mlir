  ...
  ^bb4():
    "func.func"() <{"function_type" = () -> i32, "sym_name" = "func0"}> ({
      ^bb6(%arg6_0 : i64, %arg6_1 : i64, %arg6_2 : i64):
        ...
        %34 = "riscv.divu"(%32, %37) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %30 = "riscv.divu"(%34, %34) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %26 = "riscv.xor"(%34, %30) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %22 = "riscv.sra"(%34, %26) : (!riscv.reg, !riscv.reg) -> !riscv.reg
