  ...
  ^bb4():
    "func.func"() <{"function_type" = () -> i1, "sym_name" = "func0"}> ({
      ^bb6(%arg6_0 : i64, %arg6_1 : i64, %arg6_2 : i64):
        ...
        %27 = "riscv.sltu"(%26, %25) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %28 = "riscv.xori"(%27) {immediate = 1 : si12} : (!riscv.reg) -> !riscv.reg
        ...
        %15 = "riscv.slt"(%13, %23) : (!riscv.reg, !riscv.reg) -> !riscv.reg
