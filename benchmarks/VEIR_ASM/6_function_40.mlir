  ...
  ^bb4():
    "func.func"() <{"function_type" = () -> i32, "sym_name" = "func0"}> ({
      ^bb6(%arg6_0 : i64, %arg6_1 : i64, %arg6_2 : i64):
        ...
        %32 = "riscv.divu"(%36, %31) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %28 = "riscv.rem"(%36, %32) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %23 = "builtin.unrealized_conversion_cast"(%arg6_2) : (i64) -> !riscv.reg
        %24 = "riscv.xor"(%23, %28) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %20 = "riscv.divu"(%36, %24) : (!riscv.reg, !riscv.reg) -> !riscv.reg
