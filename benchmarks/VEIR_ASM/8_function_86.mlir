  ...
  ^bb4():
    "func.func"() <{"function_type" = () -> i1, "sym_name" = "func0"}> ({
      ^bb6(%arg6_0 : i64, %arg6_1 : i64, %arg6_2 : i32):
        ...
        %40 = "builtin.unrealized_conversion_cast"(%arg6_2) : (i32) -> !riscv.reg
        %41 = "riscv.zext.w"(%40) : (!riscv.reg) -> !riscv.reg
        %38 = "riscv.srl"(%45, %41) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %32 = "builtin.unrealized_conversion_cast"(%arg6_1) : (i64) -> !riscv.reg
        %34 = "riscv.and"(%38, %32) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        ...
        %25 = "riscv.xor"(%28, %38) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %20 = "riscv.slt"(%25, %25) : (!riscv.reg, !riscv.reg) -> !riscv.reg
