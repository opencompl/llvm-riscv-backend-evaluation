  ...
  ^bb4():
    "func.func"() <{"function_type" = () -> i64, "sym_name" = "func0"}> ({
      ^bb6(%arg6_0 : i64, %arg6_1 : i64, %arg6_2 : i64):
        ...
        %35 = "riscv.xor"(%34, %39) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %31 = "riscv.sra"(%39, %35) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        ...
        %23 = "riscv.czero.eqz"(%39, %22) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %24 = "riscv.czero.nez"(%21, %22) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %25 = "riscv.or"(%23, %24) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %18 = "riscv.remu"(%31, %25) : (!riscv.reg, !riscv.reg) -> !riscv.reg
