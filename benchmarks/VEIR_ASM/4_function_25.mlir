  ...
  ^bb4():
    "func.func"() <{"function_type" = () -> i1, "sym_name" = "func0"}> ({
      ^bb6(%arg6_0 : i64, %arg6_1 : i1, %arg6_2 : i64):
        ...
        %18 = "riscv.srl"(%16, %25) : (!riscv.reg, !riscv.reg) -> !riscv.reg
