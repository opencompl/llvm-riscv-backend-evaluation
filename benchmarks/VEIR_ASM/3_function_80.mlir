  ...
  ^bb4():
    "func.func"() <{"function_type" = () -> i1, "sym_name" = "func0"}> ({
      ^bb6(%arg6_0 : i32, %arg6_1 : i64):
        %22 = "builtin.unrealized_conversion_cast"(%arg6_0) : (i32) -> !riscv.reg
        %23 = "riscv.zext.w"(%22) : (!riscv.reg) -> !riscv.reg
        %20 = "riscv.div"(%23, %23) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %14 = "builtin.unrealized_conversion_cast"(%arg6_1) : (i64) -> !riscv.reg
        %15 = "riscv.slt"(%20, %14) : (!riscv.reg, !riscv.reg) -> !riscv.reg
