  ...
  ^bb4():
    "func.func"() <{"function_type" = () -> i64, "sym_name" = "func0"}> ({
      ^bb6(%arg6_0 : i64, %arg6_1 : i64, %arg6_2 : i32):
        ...
        %34 = "riscv.srl"(%37, %33) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        ...
        %27 = "riscv.rem"(%30, %26) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %23 = "riscv.srl"(%27, %30) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %19 = "riscv.sra"(%34, %23) : (!riscv.reg, !riscv.reg) -> !riscv.reg
