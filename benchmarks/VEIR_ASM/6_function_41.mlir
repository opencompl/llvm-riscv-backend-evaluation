  ...
  ^bb4():
    "func.func"() <{"function_type" = () -> i64, "sym_name" = "func0"}> ({
      ^bb6(%arg6_0 : i64, %arg6_1 : i1, %arg6_2 : i64):
        ...
        %35 = "builtin.unrealized_conversion_cast"(%arg6_1) : (i1) -> !riscv.reg
        %36 = "riscv.czero.eqz"(%33, %35) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %37 = "riscv.czero.nez"(%34, %35) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %38 = "riscv.or"(%36, %37) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %29 = "builtin.unrealized_conversion_cast"(%arg6_0) : (i64) -> !riscv.reg
        %31 = "riscv.divu"(%29, %38) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        ...
        %23 = "riscv.rem"(%31, %27) : (!riscv.reg, !riscv.reg) -> !riscv.reg
