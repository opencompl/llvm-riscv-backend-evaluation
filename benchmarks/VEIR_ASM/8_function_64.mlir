  ...
  ^bb4():
    "func.func"() <{"function_type" = () -> i1, "sym_name" = "func0"}> ({
      ^bb6(%arg6_0 : i64, %arg6_1 : i64, %arg6_2 : i64):
        ...
        %30 = "riscv.div"(%34, %29) : (!riscv.reg, !riscv.reg) -> !riscv.reg
        %26 = "riscv.remu"(%38, %30) : (!riscv.reg, !riscv.reg) -> !riscv.reg
