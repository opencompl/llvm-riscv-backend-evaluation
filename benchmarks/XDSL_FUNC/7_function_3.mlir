builtin.module {
  func.func @func0(%arg6: i64, %arg6_1: i64, %arg6_2: i32) -> i64 {
    ...
    %5 = builtin.unrealized_conversion_cast %arg6_2 : i32 to !riscv.reg
    %6 = riscv.zext.w %5 : (!riscv.reg) -> !riscv.reg
    %7 = riscv.rem %4, %6 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %8 = builtin.unrealized_conversion_cast %arg6_2 : i32 to !riscv.reg
    %9 = riscv.sext.w %8 : (!riscv.reg) -> !riscv.reg
    %10 = riscv.sra %9, %9 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %11 = riscv.divu %7, %10 : (!riscv.reg, !riscv.reg) -> !riscv.reg
