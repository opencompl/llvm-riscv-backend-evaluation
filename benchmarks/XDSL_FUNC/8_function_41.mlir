builtin.module {
  func.func @func0(%arg6: i64, %arg6_1: i64, %arg6_2: i64) -> i32 {
    ...
    %12 = riscv.sra %11, %10 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %13 = builtin.unrealized_conversion_cast %arg6 : i64 to !riscv.reg
    %14 = riscv.and %12, %13 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %15 = riscv.xor %14, %10 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %16 = riscv.remu %10, %15 : (!riscv.reg, !riscv.reg) -> !riscv.reg
