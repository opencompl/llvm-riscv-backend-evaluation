builtin.module {
  func.func @func0(%arg6: i1, %arg6_1: i64, %arg6_2: i64) -> i32 {
    ...
    %10 = riscv.sra %8, %9 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %11 = riscv.slt %7, %10 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %12 = builtin.unrealized_conversion_cast %11 : !riscv.reg to i1
    %13 = builtin.unrealized_conversion_cast %arg6_1 : i64 to !riscv.reg
    %14 = builtin.unrealized_conversion_cast %12 : i1 to !riscv.reg
    %15 = riscv.czero.eqz %10, %14 : (!riscv.reg, !riscv.reg) -> !riscv.reg
