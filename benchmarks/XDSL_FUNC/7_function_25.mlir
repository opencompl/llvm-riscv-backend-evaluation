builtin.module {
  func.func @func0(%arg6: i64, %arg6_1: i64, %arg6_2: i64, %arg6_3: i32) -> i64 {
    ...
    %7 = riscv.czero.nez %2, %5 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    ...
    %12 = riscv.remu %8, %2 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %13 = builtin.unrealized_conversion_cast %9 : i1 to !riscv.reg
