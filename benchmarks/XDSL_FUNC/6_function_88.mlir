builtin.module {
  func.func @func0(%arg6: i64, %arg6_1: i1, %arg6_2: i64) -> i1 {
    ...
    %6 = riscv.or %5, %5 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %7 = builtin.unrealized_conversion_cast %arg6 : i64 to !riscv.reg
    %8 = riscv.slt %7, %6 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %9 = builtin.unrealized_conversion_cast %8 : !riscv.reg to i1
    %10 = builtin.unrealized_conversion_cast %9 : i1 to !riscv.reg
    %11 = riscv.czero.eqz %6, %10 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %12 = riscv.czero.nez %5, %10 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %13 = riscv.or %11, %12 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %14 = builtin.unrealized_conversion_cast %arg6 : i64 to !riscv.reg
    %15 = riscv.rem %13, %14 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %16 = riscv.xor %15, %13 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %17 = riscv.sltiu %16, 1 : (!riscv.reg) -> !riscv.reg
