...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.shl %arg2, %0 overflow<nsw, nuw> : i64
    %3 = llvm.srem %1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.shl %arg1, %arg1 overflow<nsw> : i64
    %2 = llvm.and %0, %1 : i64
    %3 = llvm.mul %2, %0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %arg0, %arg2 overflow<nsw> : i64
    %3 = llvm.srem %1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.xor %2, %1 : i64
    %4 = llvm.sub %3, %1 overflow<nuw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.add %arg2, %arg1 overflow<nsw> : i64
    %4 = llvm.sub %2, %3 : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.xor %1, %2 : i64
    %4 = llvm.sub %arg0, %3 overflow<nuw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.or disjoint %0, %1 : i64
    %3 = llvm.mul %arg1, %0 overflow<nsw> : i64
    %4 = llvm.lshr %2, %3 : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sdiv exact %0, %arg1 : i64
    %2 = llvm.sub %arg2, %arg1 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %1, %arg1 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.mul %arg0, %arg2 overflow<nuw> : i64
    %1 = llvm.sub %arg1, %0 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %3 = llvm.shl %2, %2 overflow<nsw> : i64
    %4 = llvm.add %arg0, %3 overflow<nsw> : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.srem %0, %0 : i64
    %2 = llvm.shl %0, %arg2 overflow<nsw> : i64
    %3 = llvm.lshr %1, %2 : i64
    %4 = llvm.mul %3, %2 : i64
    return %4 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.or disjoint %arg0, %0 : i64
    %2 = llvm.sub %arg1, %arg0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.add %3, %arg1 overflow<nsw> : i64
    return %4 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.add %arg0, %3 overflow<nuw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.or disjoint %0, %1 : i64
    %3 = llvm.sub %arg0, %arg0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.srem %0, %arg2 : i64
    %2 = llvm.sdiv exact %arg2, %arg0 : i64
    %3 = llvm.ashr %1, %2 : i64
    %4 = llvm.add %0, %3 overflow<nuw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sub %arg1, %arg2 : i64
    %2 = llvm.sub %1, %0 overflow<nuw> : i64
    %3 = llvm.udiv %2, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.shl %arg2, %arg0 overflow<nuw> : i64
    %1 = llvm.xor %arg1, %0 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.shl %arg2, %arg0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.srem %1, %arg1 : i64
    %3 = llvm.mul %arg1, %1 overflow<nsw> : i64
    %4 = llvm.lshr %2, %3 : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %arg2, %arg2 overflow<nsw> : i64
    %3 = llvm.xor %1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.lshr exact %arg1, %arg1 : i64
    %3 = llvm.lshr %1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.mul %arg2, %arg2 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.shl %arg2, %1 overflow<nsw, nuw> : i64
    %4 = llvm.udiv %2, %3 : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.shl %1, %1 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sub %arg1, %0 overflow<nsw, nuw> : i64
    %2 = llvm.or disjoint %arg0, %1 : i64
    %3 = llvm.add %2, %arg2 overflow<nsw> : i64
    %4 = llvm.sub %3, %3 overflow<nsw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.ashr %0, %1 : i64
    %3 = llvm.shl %1, %arg0 overflow<nuw> : i64
    %4 = llvm.urem %2, %3 : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.add %3, %3 overflow<nsw, nuw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.shl %1, %arg1 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.shl %arg1, %arg1 overflow<nsw> : i64
    %1 = llvm.xor %0, %arg2 : i64
    %2 = llvm.lshr %arg0, %1 : i64
    %3 = llvm.sub %arg0, %2 overflow<nuw> : i64
    %4 = llvm.add %3, %3 : i64
