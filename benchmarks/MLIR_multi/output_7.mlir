module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.add %arg1, %arg2 overflow<nuw> : i64
    %1 = llvm.urem %0, %0 : i64
    %2 = llvm.lshr exact %1, %0 : i64
    %3 = llvm.add %arg0, %2 overflow<nsw, nuw> : i64
    %4 = llvm.sub %1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.mul %arg1, %arg1 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.shl %arg2, %0 overflow<nuw> : i64
    %2 = llvm.mul %arg2, %1 overflow<nuw> : i64
    %3 = llvm.shl %0, %2 overflow<nsw, nuw> : i64
    %4 = llvm.and %0, %arg0 : i64
    %5 = llvm.add %0, %4 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.sub %arg2, %0 overflow<nsw, nuw> : i64
    %4 = llvm.shl %arg1, %3 overflow<nsw, nuw> : i64
    %5 = llvm.xor %2, %4 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %6 = llvm.shl %2, %5 overflow<nuw> : i64
    return %6 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %arg2, %1 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.mul %arg0, %0 overflow<nsw, nuw> : i64
    %5 = llvm.mul %3, %4 : i64
    %6 = llvm.udiv %0, %5 : i64
    return %6 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.shl %arg1, %arg0 overflow<nuw> : i64
    %2 = llvm.sdiv exact %1, %1 : i64
    %3 = llvm.shl %arg0, %arg2 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.udiv %arg0, %0 : i64
    %2 = llvm.sub %arg0, %1 overflow<nsw> : i64
    %3 = llvm.ashr exact %arg1, %arg2 : i64
    %4 = llvm.and %arg0, %3 : i64
    %5 = llvm.or %4, %3 : i64
    %6 = llvm.sub %2, %5 overflow<nsw> : i64
    return %6 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.and %2, %2 : i64
    %4 = llvm.sub %1, %3 overflow<nuw> : i64
    %5 = llvm.sub %arg0, %4 : i64
    %6 = llvm.or %0, %5 : i64
    return %6 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.shl %arg2, %3 overflow<nsw> : i64
    %5 = llvm.mul %3, %4 overflow<nsw, nuw> : i64
    %6 = llvm.add %5, %5 : i64
    return %6 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.sub %1, %1 overflow<nsw, nuw> : i64
    %3 = llvm.urem %0, %2 : i64
    %4 = llvm.sub %1, %arg1 : i64
    %5 = llvm.add %4, %arg2 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.add %1, %3 overflow<nsw, nuw> : i64
    %5 = llvm.mul %0, %4 overflow<nsw> : i64
    %6 = llvm.ashr %4, %5 : i64
    return %6 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %4 = llvm.lshr exact %1, %2 : i64
    %5 = llvm.xor %4, %arg0 : i64
    %6 = llvm.lshr exact %3, %5 : i64
    return %6 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.udiv %2, %3 : i64
    %5 = llvm.mul %1, %4 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.srem %0, %1 : i64
    %3 = llvm.and %0, %2 : i64
    %4 = llvm.shl %arg0, %2 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sub %0, %arg2 : i64
    %2 = llvm.urem %1, %arg1 : i64
    %3 = llvm.add %2, %arg1 overflow<nuw> : i64
    %4 = llvm.xor %0, %3 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.mul %0, %arg2 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.lshr exact %arg1, %arg2 : i64
    %5 = llvm.sdiv %3, %4 : i64
    %6 = llvm.add %5, %5 overflow<nsw, nuw> : i64
    return %6 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.shl %0, %1 : i64
    %3 = llvm.urem %2, %arg1 : i64
    %4 = llvm.add %arg0, %3 overflow<nsw> : i64
    %5 = llvm.add %arg1, %arg0 overflow<nsw> : i64
    %6 = llvm.and %4, %5 : i64
    return %6 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %6 = llvm.shl %arg0, %5 overflow<nsw, nuw> : i64
    return %6 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.xor %arg0, %0 : i64
    %2 = llvm.and %arg2, %1 : i64
    %3 = llvm.mul %2, %arg1 overflow<nuw> : i64
    %4 = llvm.and %3, %arg0 : i64
    %5 = llvm.udiv %1, %4 : i64
    %6 = llvm.mul %arg0, %5 overflow<nuw> : i64
    return %6 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %5 = llvm.mul %2, %4 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.add %arg1, %arg1 overflow<nsw> : i64
    %2 = llvm.ashr exact %1, %arg1 : i64
    %3 = llvm.udiv %0, %2 : i64
    %4 = llvm.shl %0, %arg2 : i64
    %5 = llvm.and %4, %3 : i64
    %6 = llvm.urem %3, %5 : i64
    return %6 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.shl %arg2, %3 overflow<nsw, nuw> : i64
    %5 = llvm.xor %2, %4 : i64
    %6 = llvm.and %0, %5 : i64
    return %6 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.udiv %0, %3 : i64
    %5 = llvm.sub %4, %4 overflow<nsw, nuw> : i64
    %6 = llvm.and %4, %5 : i64
    return %6 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.lshr %arg1, %arg2 : i64
    %1 = llvm.add %arg2, %arg1 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.shl %arg0, %arg0 : i64
    %1 = llvm.mul %0, %0 overflow<nsw> : i64
    %2 = llvm.mul %arg1, %arg0 overflow<nsw, nuw> : i64
    %3 = llvm.add %2, %2 overflow<nsw> : i64
    %4 = llvm.sub %arg2, %3 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.and %arg0, %arg1 : i64
    %1 = llvm.shl %arg0, %arg1 overflow<nsw> : i64
    %2 = llvm.xor %1, %0 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.mul %arg1, %arg0 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.shl %arg1, %arg2 overflow<nuw> : i64
    %1 = llvm.urem %arg0, %0 : i64
    %2 = llvm.add %arg1, %1 : i64
    %3 = llvm.srem %2, %0 : i64
    %4 = llvm.shl %arg2, %3 overflow<nsw, nuw> : i64
    %5 = llvm.sub %0, %4 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sub %arg2, %arg2 overflow<nsw> : i64
    %2 = llvm.add %0, %1 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.and %0, %1 : i64
    %3 = llvm.ashr exact %0, %arg0 : i64
    %4 = llvm.sub %2, %3 : i64
    %5 = llvm.sub %arg2, %4 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.sub %arg1, %3 overflow<nuw> : i64
    %5 = llvm.add %arg2, %4 overflow<nsw, nuw> : i64
    %6 = llvm.lshr exact %2, %5 : i64
    return %6 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.sub %arg0, %1 overflow<nuw> : i64
    %3 = llvm.mul %2, %2 overflow<nsw> : i64
    %4 = llvm.srem %arg1, %3 : i64
    %5 = llvm.sub %4, %arg2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.add %3, %arg0 overflow<nsw, nuw> : i64
    %5 = llvm.sdiv exact %0, %4 : i64
    %6 = llvm.shl %0, %5 overflow<nsw> : i64
    return %6 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.shl %arg1, %2 overflow<nsw, nuw> : i64
    %4 = llvm.ashr %3, %1 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.urem %0, %1 : i64
    %3 = llvm.sub %2, %2 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.sub %arg0, %arg2 overflow<nsw, nuw> : i64
    %4 = llvm.sdiv exact %1, %3 : i64
    %5 = llvm.sub %2, %4 overflow<nsw> : i64
    %6 = llvm.sdiv %0, %5 : i64
    return %6 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %arg2, %1 overflow<nuw> : i64
    %3 = llvm.sdiv %0, %2 : i64
    %4 = llvm.urem %0, %0 : i64
    %5 = llvm.sdiv %3, %4 : i64
    %6 = llvm.udiv %3, %5 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.mul %0, %0 overflow<nuw> : i64
    %2 = llvm.xor %1, %arg0 : i64
    %3 = llvm.mul %arg0, %2 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.urem %1, %3 : i64
    %5 = llvm.sdiv %0, %4 : i64
    %6 = llvm.shl %arg0, %5 overflow<nsw> : i64
    return %6 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.udiv %2, %3 : i64
    %5 = llvm.sub %arg2, %arg1 overflow<nsw, nuw> : i64
    %6 = llvm.or %4, %5 : i64
    return %6 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %4 = llvm.sub %3, %0 overflow<nsw, nuw> : i64
    %5 = llvm.sub %2, %4 overflow<nsw> : i64
    %6 = llvm.srem %1, %5 : i64
    return %6 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.mul %arg2, %arg0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.srem %arg0, %arg1 : i64
    %1 = llvm.shl %arg1, %arg2 overflow<nsw> : i64
    %2 = llvm.shl %1, %arg1 : i64
...
module {
  func.func @main(%arg0: i64) -> i64 {
    ...
    %3 = llvm.ashr %1, %1 : i64
    %4 = llvm.sub %0, %3 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.urem %0, %1 : i64
    %3 = llvm.shl %0, %arg2 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.add %arg1, %arg1 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.sub %arg2, %arg0 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.urem %0, %0 : i64
    %2 = llvm.sdiv exact %arg0, %1 : i64
    %3 = llvm.or disjoint %arg0, %arg2 : i64
    %4 = llvm.srem %3, %arg1 : i64
    %5 = llvm.shl %4, %1 overflow<nsw, nuw> : i64
    %6 = llvm.sdiv %2, %5 : i64
    return %6 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %1, %arg1 overflow<nsw, nuw> : i64
    %3 = llvm.sub %0, %1 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.ashr exact %arg0, %0 : i64
    %2 = llvm.shl %arg2, %0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.udiv %arg0, %arg0 : i64
    %1 = llvm.add %arg1, %0 overflow<nsw, nuw> : i64
    %2 = llvm.sub %arg0, %arg0 overflow<nsw> : i64
    %3 = llvm.ashr exact %1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.urem %arg1, %arg2 : i64
    %1 = llvm.sdiv %arg0, %0 : i64
    %2 = llvm.shl %arg2, %arg2 overflow<nuw> : i64
    %3 = llvm.sub %0, %0 overflow<nsw> : i64
    %4 = llvm.and %1, %3 : i64
    %5 = llvm.ashr %2, %4 : i64
    %6 = llvm.sdiv exact %1, %5 : i64
    return %6 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.ashr exact %0, %arg0 : i64
    %4 = llvm.lshr %2, %3 : i64
    %5 = llvm.shl %arg2, %4 : i64
    %6 = llvm.mul %1, %5 overflow<nuw> : i64
    return %6 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.urem %0, %0 : i64
    %2 = llvm.shl %1, %1 overflow<nsw, nuw> : i64
    %3 = llvm.shl %arg0, %2 : i64
    %4 = llvm.mul %3, %arg2 overflow<nuw> : i64
    %5 = llvm.sdiv exact %4, %0 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sub %arg0, %0 overflow<nsw> : i64
    %2 = llvm.add %arg1, %arg2 : i64
    %3 = llvm.udiv %arg0, %2 : i64
    %4 = llvm.xor %1, %3 : i64
    %5 = llvm.add %arg1, %2 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.srem %0, %2 : i64
    %4 = llvm.udiv %3, %2 : i64
    %5 = llvm.sub %4, %arg2 overflow<nsw> : i64
    %6 = llvm.urem %3, %5 : i64
    return %6 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.or %arg0, %0 : i64
    %2 = llvm.sub %arg2, %1 overflow<nuw> : i64
    %3 = llvm.urem %1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.sub %arg1, %arg2 overflow<nsw, nuw> : i64
    %3 = llvm.ashr %1, %1 : i64
    %4 = llvm.urem %3, %0 : i64
    %5 = llvm.sdiv %2, %4 : i64
    %6 = llvm.udiv %1, %5 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.or disjoint %arg2, %arg0 : i64
    %3 = llvm.xor %arg1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.xor %2, %3 : i64
    %5 = llvm.shl %0, %4 : i64
    %6 = llvm.sub %5, %arg1 overflow<nuw> : i64
    return %6 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.sub %1, %0 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.udiv %1, %3 : i64
    %5 = llvm.mul %0, %4 overflow<nuw> : i64
