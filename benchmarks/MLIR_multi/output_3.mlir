...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.mul %arg2, %0 overflow<nuw> : i64
    %2 = llvm.shl %0, %1 : i64
    return %2 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.sdiv exact %arg2, %arg0 : i64
    %1 = llvm.udiv %arg1, %0 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.shl %0, %arg1 overflow<nsw> : i64
    %2 = llvm.udiv %arg0, %1 : i64
    return %2 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.shl %0, %0 overflow<nsw, nuw> : i64
    %2 = llvm.sub %arg0, %1 overflow<nsw> : i64
    return %2 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.shl %arg2, %arg1 overflow<nsw> : i64
    %1 = llvm.xor %arg1, %0 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sub %arg2, %arg1 overflow<nuw> : i64
    %2 = llvm.sdiv exact %0, %1 : i64
    return %2 : i64
  }
}
