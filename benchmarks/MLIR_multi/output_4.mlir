...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.add %arg2, %arg2 : i64
    %2 = llvm.sub %arg1, %1 overflow<nsw, nuw> : i64
    %3 = llvm.ashr %0, %2 : i64
    return %3 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.mul %arg1, %arg0 overflow<nsw> : i64
    %3 = llvm.xor %1, %2 : i64
    return %3 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.sub %arg2, %arg0 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.and %1, %0 : i64
    %3 = llvm.shl %arg0, %2 overflow<nsw> : i64
    return %3 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.or disjoint %arg1, %arg2 : i64
    %3 = llvm.sdiv exact %1, %2 : i64
    return %3 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %arg1, %arg2 overflow<nuw> : i64
    %3 = llvm.xor %1, %2 : i64
    return %3 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.shl %2, %arg2 overflow<nuw> : i64
    return %3 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.urem %arg0, %arg1 : i64
    %1 = llvm.shl %arg2, %arg2 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %1, %arg2 overflow<nsw, nuw> : i64
    %3 = llvm.lshr %arg0, %2 : i64
    return %3 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    %0 = llvm.ashr %arg0, %arg0 : i64
    %1 = llvm.sub %0, %arg1 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.mul %1, %arg0 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.urem %arg0, %1 : i64
    %3 = llvm.mul %2, %1 overflow<nsw> : i64
    return %3 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.urem %arg0, %arg1 : i64
    %1 = llvm.xor %0, %0 : i64
    %2 = llvm.mul %0, %arg2 overflow<nuw> : i64
    %3 = llvm.srem %1, %2 : i64
    return %3 : i64
  }
}
