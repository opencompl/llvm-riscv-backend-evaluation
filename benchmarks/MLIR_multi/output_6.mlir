module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.udiv %1, %2 : i64
    %4 = llvm.sub %1, %arg2 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.shl %1, %arg0 overflow<nsw, nuw> : i64
    %3 = llvm.udiv %0, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %5 = llvm.add %4, %arg1 overflow<nsw, nuw> : i64
    return %5 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sub %0, %0 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.sub %arg0, %3 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.shl %3, %0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.mul %arg1, %arg1 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sub %0, %arg0 overflow<nsw, nuw> : i64
    %2 = llvm.or %0, %1 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %5 = llvm.mul %1, %4 overflow<nuw> : i64
    return %5 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.ashr %arg0, %0 : i64
    %2 = llvm.or disjoint %0, %0 : i64
    %3 = llvm.lshr exact %arg2, %2 : i64
    %4 = llvm.shl %3, %1 : i64
    %5 = llvm.or %1, %4 : i64
    return %5 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.shl %arg2, %2 overflow<nuw> : i64
    %4 = llvm.and %1, %3 : i64
    %5 = llvm.ashr %2, %4 : i64
    return %5 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.mul %arg1, %arg2 overflow<nsw> : i64
    %1 = llvm.mul %arg0, %0 overflow<nsw, nuw> : i64
    %2 = llvm.sub %0, %arg2 overflow<nsw, nuw> : i64
    %3 = llvm.or %2, %1 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.add %arg2, %arg0 overflow<nsw> : i64
    %2 = llvm.sdiv %1, %arg1 : i64
    %3 = llvm.and %arg0, %2 : i64
    %4 = llvm.sub %arg2, %3 overflow<nsw> : i64
    %5 = llvm.srem %0, %4 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.mul %1, %2 overflow<nsw, nuw> : i64
    %4 = llvm.sdiv %0, %arg2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %5 = llvm.add %1, %4 overflow<nsw> : i64
    return %5 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.add %arg1, %arg0 overflow<nsw, nuw> : i64
    %3 = llvm.xor %1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.add %arg2, %0 overflow<nuw> : i64
    %4 = llvm.udiv %2, %3 : i64
    %5 = llvm.lshr exact %0, %4 : i64
    return %5 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.add %3, %arg1 overflow<nsw, nuw> : i64
    %5 = llvm.lshr exact %4, %arg2 : i64
    return %5 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.sub %arg1, %arg1 overflow<nsw> : i64
    %1 = llvm.or %0, %0 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.shl %1, %arg2 overflow<nuw> : i64
    %3 = llvm.xor %0, %2 : i64
    %4 = llvm.sub %arg0, %3 : i64
    %5 = llvm.ashr %4, %1 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.mul %3, %2 overflow<nsw, nuw> : i64
    %5 = llvm.and %2, %4 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %arg2, %arg0 : i64
    %3 = llvm.add %1, %2 : i64
    %4 = llvm.or %3, %arg2 : i64
    %5 = llvm.lshr exact %arg0, %4 : i64
    return %5 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    %0 = llvm.udiv %arg0, %arg0 : i64
    %1 = llvm.mul %arg0, %arg1 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.xor %1, %0 : i64
    %3 = llvm.urem %0, %2 : i64
    %4 = llvm.shl %arg2, %arg2 overflow<nuw> : i64
    %5 = llvm.and %3, %4 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.lshr exact %arg0, %0 : i64
    %2 = llvm.mul %1, %1 overflow<nuw> : i64
    %3 = llvm.and %arg0, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.shl %0, %arg0 overflow<nsw, nuw> : i64
    %2 = llvm.udiv %arg0, %1 : i64
    %3 = llvm.mul %arg2, %2 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.add %arg2, %arg0 overflow<nuw> : i64
    %4 = llvm.mul %3, %1 overflow<nsw, nuw> : i64
    %5 = llvm.shl %2, %4 overflow<nsw> : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.srem %arg0, %arg0 : i64
    %1 = llvm.srem %arg1, %arg2 : i64
    %2 = llvm.mul %0, %arg1 overflow<nuw> : i64
    %3 = llvm.ashr %2, %1 : i64
    %4 = llvm.shl %1, %3 overflow<nsw> : i64
    %5 = llvm.sub %0, %4 overflow<nsw> : i64
    return %5 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.srem %arg0, %arg0 : i64
    %1 = llvm.add %0, %arg1 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.mul %0, %arg2 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.sdiv exact %0, %2 : i64
    %4 = llvm.sub %3, %1 overflow<nsw, nuw> : i64
    %5 = llvm.sdiv %1, %4 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.shl %arg2, %2 overflow<nuw> : i64
    %4 = llvm.shl %arg1, %3 overflow<nsw> : i64
    %5 = llvm.srem %1, %4 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.lshr %arg0, %arg1 : i64
    %1 = llvm.add %arg2, %0 : i64
    %2 = llvm.sub %1, %arg2 : i64
    %3 = llvm.sdiv %0, %2 : i64
    %4 = llvm.shl %3, %arg1 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.shl %arg0, %arg0 overflow<nsw, nuw> : i64
    %1 = llvm.mul %0, %arg1 overflow<nuw> : i64
    %2 = llvm.srem %arg0, %0 : i64
    %3 = llvm.add %arg2, %2 overflow<nuw> : i64
    %4 = llvm.sub %3, %arg0 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %3 = llvm.mul %2, %arg1 overflow<nsw, nuw> : i64
    %4 = llvm.urem %3, %arg0 : i64
    %5 = llvm.sub %4, %2 overflow<nsw> : i64
    return %5 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.sub %arg2, %0 overflow<nsw, nuw> : i64
    %3 = llvm.and %1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.srem %0, %1 : i64
    %3 = llvm.or disjoint %arg0, %arg1 : i64
    %4 = llvm.xor %3, %2 : i64
    %5 = llvm.sdiv exact %2, %4 : i64
    return %5 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    %0 = llvm.mul %arg1, %arg1 overflow<nsw, nuw> : i64
    %1 = llvm.ashr %arg0, %0 : i64
    %2 = llvm.urem %1, %1 : i64
    %3 = llvm.sub %1, %arg1 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.add %2, %2 overflow<nuw> : i64
    %4 = llvm.and %3, %2 : i64
    %5 = llvm.ashr exact %1, %4 : i64
    return %5 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.shl %arg2, %1 overflow<nuw> : i64
    %3 = llvm.or %arg1, %2 : i64
    %4 = llvm.sub %3, %0 overflow<nsw> : i64
    %5 = llvm.add %0, %4 overflow<nsw, nuw> : i64
    return %5 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.shl %2, %1 overflow<nsw> : i64
