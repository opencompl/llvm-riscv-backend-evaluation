...
def main():
    ...
    commands[f"GeomeanInstructionsRatioVeirllvmVsSdag"] = float(d[c])
    p = geomean_ratio(df_instructions, "tot_instructions", "VEIR_xdsl", "LLVM_selectiondag")
    commands[f"GeomeanInstructionsRatioVeirxdslVsSdag"] = float(d[c])
    p = geomean_ratio(df_instructions, "tot_instructions", "VEIR_llvm", "LLVM_globalisel")
    commands[f"GeomeanInstructionsRatioVeirllvmVsGisel"] = float(d[c])
    p = geomean_ratio(df_instructions, "tot_instructions", "VEIR_xdsl", "LLVM_globalisel")
    commands[f"GeomeanInstructionsRatioVeirxdslVsGisel"] = float(d[c])
