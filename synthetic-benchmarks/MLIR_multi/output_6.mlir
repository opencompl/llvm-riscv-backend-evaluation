...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.or disjoint %arg0, %arg1 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.shl %arg1, %arg2 overflow<nsw, nuw> : i64
    %2 = llvm.xor %arg0, %arg0 : i64
    %3 = llvm.or %1, %2 : i64
    %4 = llvm.urem %0, %3 : i64
    %5 = llvm.shl %4, %arg1 overflow<nuw> : i64
    return %5 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.srem %arg1, %arg2 : i64
    %1 = llvm.mul %arg0, %arg2 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.xor %1, %2 : i64
    %4 = llvm.sub %3, %arg1 overflow<nsw> : i64
    %5 = llvm.shl %4, %0 overflow<nsw> : i64
    return %5 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.add %arg0, %arg1 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.shl %arg0, %1 overflow<nsw, nuw> : i64
    %4 = llvm.or %2, %3 : i64
    %5 = llvm.sdiv exact %arg0, %4 : i64
    return %5 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %5 = llvm.sub %0, %4 overflow<nsw, nuw> : i64
    return %5 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.mul %2, %0 overflow<nsw, nuw> : i64
    %4 = llvm.sub %0, %3 overflow<nuw> : i64
    %5 = llvm.ashr %0, %4 : i64
    return %5 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sub %arg0, %arg2 overflow<nsw> : i64
    %2 = llvm.sub %arg0, %1 : i64
    %3 = llvm.add %0, %arg0 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.sub %arg2, %arg1 overflow<nuw> : i64
    %1 = llvm.add %arg1, %0 overflow<nsw> : i64
    %2 = llvm.urem %arg0, %1 : i64
    %3 = llvm.xor %arg1, %arg2 : i64
    %4 = llvm.mul %2, %3 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %3 = llvm.urem %1, %2 : i64
    %4 = llvm.sub %arg0, %arg1 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    %0 = llvm.sub %arg1, %arg0 overflow<nuw> : i64
    %1 = llvm.xor %arg0, %0 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.sdiv exact %arg0, %arg0 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.mul %arg2, %arg1 : i64
    %2 = llvm.ashr %0, %1 : i64
    %3 = llvm.add %1, %0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.shl %arg0, %arg1 overflow<nuw> : i64
    %3 = llvm.shl %1, %2 : i64
    %4 = llvm.ashr exact %3, %2 : i64
    %5 = llvm.urem %4, %2 : i64
    return %5 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.sub %arg1, %3 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.mul %arg1, %arg1 overflow<nsw> : i64
    %1 = llvm.srem %0, %0 : i64
    %2 = llvm.srem %arg0, %1 : i64
    %3 = llvm.shl %2, %arg2 : i64
    %4 = llvm.or %arg0, %3 : i64
    %5 = llvm.or disjoint %4, %arg0 : i64
    return %5 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.ashr exact %0, %arg2 : i64
    %2 = llvm.srem %0, %1 : i64
    %3 = llvm.shl %arg1, %arg0 overflow<nsw> : i64
    %4 = llvm.urem %2, %3 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.mul %arg2, %arg2 overflow<nsw> : i64
    %5 = llvm.xor %3, %4 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %4 = llvm.shl %3, %arg1 overflow<nsw> : i64
    %5 = llvm.mul %2, %4 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.shl %arg1, %arg1 overflow<nsw, nuw> : i64
    %3 = llvm.srem %2, %arg0 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.sdiv exact %arg0, %arg1 : i64
    %1 = llvm.add %arg1, %arg2 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.sub %2, %arg1 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.ashr %1, %0 : i64
    %3 = llvm.sub %2, %0 overflow<nsw, nuw> : i64
    %4 = llvm.srem %0, %3 : i64
    %5 = llvm.ashr %4, %3 : i64
    return %5 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.mul %arg1, %1 overflow<nuw> : i64
    %3 = llvm.udiv %arg2, %2 : i64
    %4 = llvm.shl %0, %3 : i64
    %5 = llvm.ashr exact %4, %arg1 : i64
    return %5 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.mul %arg2, %0 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %5 = llvm.mul %3, %4 overflow<nsw> : i64
    return %5 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.shl %2, %3 overflow<nsw> : i64
    %5 = llvm.urem %4, %arg2 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.srem %arg2, %0 : i64
    %2 = llvm.urem %1, %arg2 : i64
    %3 = llvm.mul %1, %1 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.shl %arg1, %arg2 : i64
    %1 = llvm.udiv %arg1, %0 : i64
    %2 = llvm.add %0, %arg1 overflow<nsw, nuw> : i64
    %3 = llvm.srem %1, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.sub %arg1, %arg2 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.add %3, %1 overflow<nuw> : i64
    %5 = llvm.sub %2, %4 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    %0 = llvm.urem %arg0, %arg0 : i64
    %1 = llvm.sub %0, %arg1 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.mul %arg2, %arg1 : i64
    %1 = llvm.or %arg1, %0 : i64
    %2 = llvm.and %arg0, %1 : i64
    %3 = llvm.mul %arg0, %2 overflow<nsw> : i64
    %4 = llvm.add %3, %2 overflow<nuw> : i64
    %5 = llvm.sdiv %3, %4 : i64
    return %5 : i64
  }
}
