module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %1, %arg0 overflow<nsw, nuw> : i64
    %3 = llvm.mul %0, %2 overflow<nsw> : i64
    %4 = llvm.sub %3, %arg2 : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.sub %arg1, %2 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.shl %arg2, %arg2 overflow<nsw> : i64
    %3 = llvm.or disjoint %1, %2 : i64
    %4 = llvm.add %3, %arg2 : i64
    return %4 : i64
  }
}
// -----
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sub %0, %arg1 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.mul %2, %1 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.srem %0, %1 : i64
    %3 = llvm.sub %1, %0 overflow<nuw> : i64
    %4 = llvm.and %2, %3 : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.or %0, %1 : i64
    %3 = llvm.sdiv exact %arg2, %arg1 : i64
    %4 = llvm.and %2, %3 : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.mul %2, %arg1 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.mul %arg1, %arg0 overflow<nsw, nuw> : i64
    %1 = llvm.or %arg0, %0 : i64
    %2 = llvm.and %0, %1 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.shl %0, %arg1 : i64
    %2 = llvm.and %arg1, %1 : i64
    %3 = llvm.shl %arg0, %2 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.mul %arg1, %arg2 overflow<nsw> : i64
    %2 = llvm.and %arg1, %1 : i64
    %3 = llvm.or %1, %2 : i64
    %4 = llvm.mul %0, %3 : i64
    return %4 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.add %arg1, %arg2 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %3 = llvm.xor %1, %2 : i64
    %4 = llvm.add %3, %arg1 overflow<nuw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %4 = llvm.sub %1, %3 overflow<nsw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %3 = llvm.shl %arg1, %2 overflow<nuw> : i64
    %4 = llvm.xor %1, %3 : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.or disjoint %1, %2 : i64
    %4 = llvm.sub %0, %3 overflow<nsw, nuw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.urem %arg0, %arg0 : i64
    %1 = llvm.sub %arg2, %arg2 overflow<nuw> : i64
    %2 = llvm.and %arg1, %1 : i64
    %3 = llvm.srem %0, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.or %0, %arg0 : i64
    %2 = llvm.sub %arg1, %arg2 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.srem %arg0, %arg1 : i64
    %1 = llvm.or disjoint %arg2, %arg2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %2 = llvm.mul %1, %arg0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.or %0, %2 : i64
    %4 = llvm.sub %3, %arg2 overflow<nsw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.add %arg2, %arg0 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %3 = llvm.mul %0, %2 overflow<nsw, nuw> : i64
    %4 = llvm.mul %arg0, %3 : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.and %arg1, %0 : i64
    %2 = llvm.mul %1, %0 overflow<nuw> : i64
    %3 = llvm.sdiv %0, %2 : i64
    %4 = llvm.urem %arg0, %3 : i64
    return %4 : i64
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.xor %1, %1 : i64
    %3 = llvm.udiv %0, %2 : i64
    %4 = llvm.shl %3, %3 overflow<nuw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %3 = llvm.lshr %0, %2 : i64
    %4 = llvm.mul %3, %arg0 overflow<nuw> : i64
    return %4 : i64
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.sub %arg0, %arg2 overflow<nsw, nuw> : i64
    %3 = llvm.mul %2, %arg2 overflow<nsw> : i64
    %4 = llvm.mul %1, %3 overflow<nsw, nuw> : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.or %arg0, %arg1 : i64
    %1 = llvm.sub %arg0, %arg0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    %0 = llvm.add %arg2, %arg2 overflow<nsw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.mul %arg1, %arg1 overflow<nsw> : i64
    %3 = llvm.sub %2, %arg1 : i64
    %4 = llvm.udiv %1, %3 : i64
    return %4 : i64
  }
}
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %2 = llvm.add %0, %arg0 overflow<nuw> : i64
    %3 = llvm.mul %arg2, %2 overflow<nsw, nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.mul %arg1, %0 overflow<nuw> : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.sdiv exact %arg2, %arg0 : i64
    %2 = llvm.shl %arg1, %1 overflow<nuw> : i64
    %3 = llvm.udiv %0, %2 : i64
    %4 = llvm.shl %arg0, %3 overflow<nsw> : i64
    return %4 : i64
  }
}
// -----
