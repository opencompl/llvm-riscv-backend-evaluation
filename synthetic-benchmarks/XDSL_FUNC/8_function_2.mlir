builtin.module {
  func.func @func0(%arg6: i64, %arg6_1: i64, %arg6_2: i64) -> i64 {
    ...
    %5 = riscv.sub %3, %4 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %6 = builtin.unrealized_conversion_cast %arg6_1 : i64 to !riscv.reg
    %7 = riscv.xor %6, %5 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %8 = riscv.div %2, %5 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %9 = builtin.unrealized_conversion_cast %arg6_1 : i64 to !riscv.reg
    %10 = riscv.mul %9, %7 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %11 = riscv.sra %8, %10 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %12 = riscv.sra %7, %11 : (!riscv.reg, !riscv.reg) -> !riscv.reg
    %13 = riscv.remu %2, %12 : (!riscv.reg, !riscv.reg) -> !riscv.reg
